...
8. **Verify & record evidence:** check each acceptance criterion; note *how* each was proven (red→green test names, output, measurements) — "implemented successfully" is not evidence.
